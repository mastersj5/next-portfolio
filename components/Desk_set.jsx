...
Command: npx gltfjsx@6.5.3 public/desk_set.glb 
    ...
    <group {...props} dispose={null}>
      <group position={[1287.773, 786.161, 833.715]} rotation={[-Math.PI / 2, 0, 0]}>
        <group position={[-360.062, -26.253, -77.9]}>
          <mesh geometry={nodes['Desk-Door_02_Desk_0'].geometry} material={materials.Desk} position={[360.062, 25.21, 77.9]} />
        </group>
        <group position={[360.063, -34.263, -77.9]}>
          <mesh geometry={nodes['Desk-Door_01_Desk_0'].geometry} material={materials.Desk} position={[360.062, 25.21, 77.9]} />
        </group>
      ...
      <group position={[1468.742, 0, 1477.194]} rotation={[-Math.PI / 2, 0, 0.96]}>
        <mesh geometry={nodes['Office-Chair_Office-Chair_0'].geometry} material={materials['Office-Chair']} position={[-16.848, 2.917, 461.853]} />
      </group>
      ...
      <mesh geometry={nodes['Book-Type2_Book-Type_2_0'].geometry} material={materials['Book-Type_2']} position={[1902.696, 860.16, 947.855]} rotation={[-Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes['Photography_Type2_Photography-Type_2_0'].geometry} material={materials['Photography-Type_2']} position={[681.144, 921.938, 581.522]} rotation={[2.879, -0.059, 3.126]} scale={1.17} />
    </group>
  )
}

useGLTF.preload('/desk_set.glb')
